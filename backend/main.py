...
from app.routers import (
    users, jobs, applications, readiness, ai, admin, courses, payments
)
...
if settings.app_mode == "demo":
    # Ensure both localhost and 127.0.0.1 are allowed for common dev ports
    extra_origins = [
...
async def startup_tasks():
    try:
        ...
        print("Startup DB tasks completed successfully")
    except Exception as e:
        print(f"WARNING: Startup DB tasks failed: {e}")
        print("Server will continue running — DB may need manual setup")
